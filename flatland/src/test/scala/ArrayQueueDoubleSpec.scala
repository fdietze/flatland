...
class ArrayQueueDoubleSpec extends AnyFreeSpec with Matchers {

  "ArrayQueueDouble" - {
    def foreachElementCollect(queue: ArrayQueueDouble): List[Double] = {
    ...
    "everything" in {
      val queue = ArrayQueueDouble.create(3)
